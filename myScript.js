...
$(document).on('mousemove touchmove', function (event) {
    ...
    currentMousePos.x = event.pageX || event.originalEvent.touches[0].pageX;
    currentMousePos.y = event.pageY || event.originalEvent.touches[0].pageY;
    ...
    var around1 = -1 * (currentMousePos.y * 100 / wHeight * 0.2 - 10) + 'deg',
        ...
        dy = currentMousePos.y - wHeight / 2, //@h/2 = center of poster
        dx = currentMousePos.x - wWidth / 2, //@w/2 = center of poster
